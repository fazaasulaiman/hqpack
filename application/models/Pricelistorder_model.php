<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
 ...
 class Pricelistorder_model extends CI_Model {
        ...
        private function _get_datatables_query($tabel)
    {
        ...
        $this->db->select("pricelist_order.id,pricelist_order.size_kertas,pricelist_order.jumlah_order,pricelist_order.insheet,pricelist_order.plano,pricelist_order.margin,hargadistributor.distributor,hargadistributor.barangjasa,hargadistributor.harga");
        $this->db->from($tabel);
