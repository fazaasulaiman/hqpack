<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
 ...
 class Invoice_model extends CI_Model {
 	 var $table = 'followup';
 	 var $column_order = array(null,'tanggal','nota','konsumen','total','status','tanggal_payment','tanggal_deadline','catatan'); 
     var $column_search = array('tanggal','nota','konsumen','total','status','tanggal_payment','tanggal_deadline','catatan'); 
        ...
        private function _get_datatables_query($tabel)
    {
        ...
        $this->db->select("konsumen.konsumen, invoice.*");
        $this->db->from($tabel);
