 ...
 table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": site_url+"Master/tampilbarang",
            "type": "POST"
        },
...
function edit(id)
{
   var url = site_url+"Master/getbarang/";
...
function hapus(id,ket){
    ...
    var url = site_url+"Master/hpsbarang/";
  $.ajax({
        url : url+id,
        type: "POST",
        dataType: "JSON",
